...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Freezer',
            fields=[
                ('freezer_location', models.CharField(max_length=50, primary_key=True, serialize=False, verbose_name='冷冻冰箱内位置')),
                ('feezer_storage', models.CharField(blank=True, max_length=100, null=True, verbose_name='样本存储信息/box_id')),
            ],
            options={
                'verbose_name': '冷冻冰箱存储信息',
                'verbose_name_plural': '冷冻冰箱存储信息',
            },
        ),
        migrations.CreateModel(
            name='Sample',
